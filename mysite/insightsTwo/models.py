...
class WeeklyStats(models.Model):
    ...
    trailing_pe = models.DecimalField(max_digits=10, decimal_places=2)
    forward_pe = models.DecimalField(max_digits=10, decimal_places=2)
    trailing_ps = models.DecimalField(max_digits=10, decimal_places=2)
    forward_ps = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    mrq_pb = models.DecimalField(max_digits=10, decimal_places=2)
    pcf = models.DecimalField(max_digits=10, decimal_places=2)
    ...
    total_debt_to_equity = models.DecimalField(max_digits=10, decimal_places=2)
    total_debt_to_capital = models.DecimalField(max_digits=10, decimal_places=2)
    roe = models.DecimalField(max_digits=10, decimal_places=2)
    roa = models.DecimalField(max_digits=10, decimal_places=2)
    roic = models.DecimalField(max_digits=10, decimal_places=2)
    bv_mv = models.DecimalField(max_digits=10, decimal_places=2)
    ass_turnover = models.DecimalField(max_digits=10, decimal_places=2)
    inv_trnover =models.DecimalField(max_digits=10, decimal_places=2)
    op_margin = models.DecimalField(max_digits=10, decimal_places=2)
    prof_margin = models.DecimalField(max_digits=10, decimal_places=2)
    gross_margin = models.DecimalField(max_digits=10, decimal_places=2)
    ev_revenue = models.DecimalField(max_digits=10, decimal_places=2)
    ev_ebitda = models.DecimalField(max_digits=10, decimal_places=2)
